...
path = "/home/seunghoi/clmr/df_new_merged_dh.csv"
merged_path = "/home/seunghoi/clmr/df_new_merged_v2.csv"
...
remove_tag = ['no strings','no piano', 'no violin', 'no guitar','instrumental', 'no flute', 'no drums', 'not classical']
...
colss = [col for col in df_new.columns if col not in remove_tag]
df_new = df_new[colss]
...
result.to_csv("df_new_merged_final_v2.csv", index=False)
